				...
				try
				{
					...
					switch (req)
					{
						case "ecowitt":
							...
							{
								await writer.WriteAsync(stationEcowitt.ProcessData(HttpContext));
							}
							else
							{
						...
						case "ecowittextra":
							...
							{
								await writer.WriteAsync(stationEcowittExtra.ProcessExtraData(HttpContext));
							}
							else
							{
								Response.StatusCode = 500;
				...
				try
				{
					...
					switch (req)
					{
						...
						case "ambient":
							...
							{
								await writer.WriteAsync(stationAmbient.ProcessData(HttpContext));
							}
							else
							{
								Response.StatusCode = 500;
						...
						case "ambientextra":
							...
							{
								await writer.WriteAsync(stationAmbientExtra.ProcessExtraData(HttpContext));
							}
							else
							{
								Response.StatusCode = 500;
