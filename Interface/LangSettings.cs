...
namespace CumulusMX
{
	internal class LangSettings
	{
		...
		public string UpdateConfig(IHttpContext context)
		{
			...
			{
				var msg = "Error de-serializing Localisation Settings";
			...
			try
			{
				...
				{
					var msg = "Error processing Zambretti forecast settings";
					cumulus.LogExceptionMessage(ex, msg);
					errorMsg += msg + "\n\n";
					context.Response.StatusCode = 500;
				}
				...
				{
					var msg = "Error processing Moon phase settings";
					cumulus.LogExceptionMessage(ex, msg);
					errorMsg += msg + "\n\n";
					context.Response.StatusCode = 500;
				}
				...
				{
					var msg = "Error processing Beaufort settings";
					cumulus.LogExceptionMessage(ex, msg);
					errorMsg += msg + "\n\n";
					context.Response.StatusCode = 500;
				}
				...
				{
					var msg = "Error processing Trend settings";
					cumulus.LogExceptionMessage(ex, msg);
					errorMsg += msg + "\n\n";
					context.Response.StatusCode = 500;
				}
				...
				{
					var msg = "Error processing Air Quality settings";
					cumulus.LogExceptionMessage(ex, msg);
					errorMsg += msg + "\n\n";
					context.Response.StatusCode = 500;
				}
				...
				{
					var msg = "Error processing Davis Forecast settings";
					cumulus.LogExceptionMessage(ex, msg);
					errorMsg += msg + "\n\n";
					context.Response.StatusCode = 500;
				}
				...
				{
					var msg = "Error processing Extra Sensor Names";
					cumulus.LogExceptionMessage(ex, msg);
					errorMsg += msg + "\n\n";
					context.Response.StatusCode = 500;
				}
				...
				{
					var msg = "Error processing CO2 settings";
					cumulus.LogExceptionMessage(ex, msg);
					errorMsg += msg + "\n\n";
					context.Response.StatusCode = 500;
				}
			...
			{
				var msg = "Error processing Localisation settings";
				cumulus.LogExceptionMessage(ex, msg);
				cumulus.LogDebugMessage("Localisation Data: " + json);
				errorMsg += msg;
				context.Response.StatusCode = 500;
