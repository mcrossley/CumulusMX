...
namespace CumulusMX
{
	public class NOAASettings
	{
		...
		public string GetAlpacaFormData()
		{
			...
			var normalrain = new NormalRainJson()
			{
		...
		public string UpdateConfig(IHttpContext context)
		{
			...
			{
				var msg = "Error de-serializing NOAA Settings JSON";
			...
			{
				var msg = "Error processing NOAA settings";
				cumulus.LogExceptionMessage(ex, msg);
				cumulus.LogDebugMessage("NOAA data: " + json);
				context.Response.StatusCode = 500;
				return msg;
		...
		private class DataJson
		{
			...
			public SiteJson sitedetails { get; set; }
			public OutputJson outputfiles { get; set; }
			public OptionsJson options { get; set; }
			public FtpCopyJson ftp { get; set; }
			public FtpCopyJson copy { get; set; }
			public ThresholdsJson thresholds { get; set; }
			public NormalMeanTempsJson normalmeantemps { get; set; }
			public NormalRainJson normalrain { get; set; }
		}
		...
		private class NormalMeanTempsJson
		{
