	...
	class HttpStationEcowitt : WeatherStation
	{
		...
		public string ProcessData(IHttpContext context)
		{
			...
			try
			{
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessData: Error in extra humidity data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessData: Error in CO₂ data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessData: Error in Lightning data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessData: Error in Leak data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessData: Error in Battery data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessData: Error calculating extra sensor dew points");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessData: Error extracting firmware version");
				}
		...
		public string ProcessExtraData(IHttpContext context)
		{
			...
			try
			{
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error in extra temperature data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error in extra humidity data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error in solar data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error in UV data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error in Soil temp data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error in Soil moisture data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error in Leaf wetness data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error in User Temp (soil or water) data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error in Air Quality data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error in CO₂ data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error in Lightning data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error in Leak data");
				}
				...
				{
					cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error in Battery data");
				}
			...
			{
				cumulus.LogExceptionMessage(ex, "ProcessExtraData: Error");
				context.Response.StatusCode = 500;
				return "Failed: General error - " + ex.Message;
			}
