	...
	internal class TempestStation : WeatherStation
	{
		...
		private void ProcessHistoryData(List<Observation> datalist)
		{
			...
			foreach (var historydata in datalist)
			{
				...
				// Outdoor Temperature ==================================================
				DoTemperature(ConvertUnits.TempCToUser((double) historydata.Temperature), timestamp);
			...
			if (wp != null)
			{
				switch (wp.MsgType)
				{
					...
					case WeatherPacket.MessageType.LightningStrike:
						...
						LightningDistance = ConvertUnits.KmtoUserUnits(wp.LightningStrike.Distance).Value;
...
namespace CumulusMX.Tempest
{
	...
	public static class StationListener
	{
		...
		public static void StartUdpListen()
		{
			if (_udpListener == null)
			{
				...
				{
					cumulus.LogExceptionMessage(ex, "Error starting UDP listener");
				}
		...
		private static void _udpListener_PacketReceived(object sender, PacketReceivedArgs e)
		{
			if (e.Packet.Length > 0)
			{
				...
				{
					cumulus.LogExceptionMessage(ex, "UDP packet received error");
				}
	...
	public class WeatherPacket
	{
		...
		public DateTime PacketTime { get => FromUnixTimeSeconds(timestamp); }
	...
	public class HubStatus
	{
		...
		public static WeatherPacket.MessageType MsgType
		{
			get => WeatherPacket.MessageType.HubStatus;
		}
	...
	public class Observation
	{
		...
		public decimal TempF { get => Temperature * 9 / 5 + 32; }
	...
	public class RapidWind
	{
		...
		public static WeatherPacket.MessageType MsgType { get => WeatherPacket.MessageType.RapidWind; }
