...
namespace CumulusMX
{
	internal class GW1000Station : WeatherStation
	{
		...
		private void GetPiezoRainData()
		{
			...
			try
			{
				var rRate = ConvertRainMMToUser(Stations.GW1000Api.ConvertBigEndianUInt16(data, 30) / 10.0);
				var rain = ConvertRainMMToUser(Stations.GW1000Api.ConvertBigEndianUInt16(data, 48) / 10.0);
